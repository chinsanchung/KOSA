...
<body>
	<form name="loginform" action="./template.jsp?page=loginProcess"
		method="post">
		<center>
			<table border=1>
				<tr>
					<td colspan="2" align=center><b><font size=5>로그인페이지</font></b>
					</td>
				</tr>
				<tr>
					<td>ID(HAKBUN):</td>
				...
				<tr>
					<td colspan="2" align=center><a
						href="javascript:check_input()">login</a>&nbsp;&nbsp; <a
						href="./template.jsp?page=joinForm">회원가입</a></td>
				</tr>
			</table>
		</center>
	</form>
