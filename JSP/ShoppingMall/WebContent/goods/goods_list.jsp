	...
	<!-- 중요.. -->   
		   <c:choose> 
				<c:when test=
					...
					<tr>
						<td width="700" height="300" align="center">등록된 글이 없습니다.</td>
					</tr>
				</c:when>
				...
				<%		}else{ %>
								<a href="Goods_Detail.go?item=${item.GOODS_CATEGORY}
										&gr_goods_num=${item.GOODS_NUM}&isitem=new&price=${price}">
				<% 		}
				...
				%>
			 	...
			 	<img src="./upload/${fn:trim(item.GOODS_IMAGE)}" width="130" height="130" 
			 		border="0"/>
