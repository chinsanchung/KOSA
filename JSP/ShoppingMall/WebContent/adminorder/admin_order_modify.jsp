...
<table width=80% border=0 cellpadding="0" cellspacing="1">
	...
	<tr height=20>
		...
		<td style="font-family: Tahoma; font-size: 8pt;"><%=order.getORDER_GOODS_NAME() %>
		</td>
	</tr>
	<tr>
		<td style="background-color: #F0F0F0; height: 1px;" colspan=6></td>
	...
	<tr height=20>
		...
		<td style="font-family: Tahoma; font-size: 8pt;"><%=order.getORDER_GOODS_SIZE()%>
		</td>
	</tr>
	<tr>
		<td style="background-color: #F0F0F0; height: 1px;" colspan=6></td>
	...
	<tr height=20>
		...
		<td style="font-family:Tahoma; font-size: 8pt;"><%=order.getORDER_RECEIVE_NAME() %>
		</td>
	</tr>
	<tr>
		<td style="background-color: #F0F0F0; height: 1px;" colspan=6></td>
	...
	<tr height=23>
		...
		<td style="font-family:Tahoma; font-size:8pt;"><%=order.getORDER_RECEIVE_PHONE() %>
		</td>
	</tr>
	<tr>
		<td style="background-color: #F0F0F0; height: 1px;" colspan=6></td>
	...
	<tr height=20>
		...
		<td style="font-family:Tahoma; font-size:8pt;"><%=order.getORDER_RECEIVE_ADDR1() %>
		</td>
	</tr>
	<tr>
		<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
	...
	<tr height=20>
		...
		<td style="font-family:Tahoma; font-size:8pt;"><%=order.getORDER_RECEIVE_ADDR2() %>
		</td>
	</tr>
	<tr>
		<td style="background-color: #F0F0F0; height: 1px;" colspan=6></td>
...
<table width=80% border=0 cellpadding="0" cellspacing="1">
	...
	<tr>
		<td align=center style="background-color: #F0F0F0; height: 1px;"
			...
			<input type=button onclick="javascript:location.href('./AdminOrderList.ao')"
			value="취소">
		</td>
	</tr>
</table>
