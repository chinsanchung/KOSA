...
<title>쇼핑몰</title>
<script>
function check(form){ //16~23줄은 필요 없다네
...
<!-- 개인정보 수정 -->
<p align="center">
<form id="infoform" action="./MemberModifyAction_2.me" method="post" name="infoform" 
...
<table border="1" width="80%" height="80%">
	...
	<tr>
		...
		<td>
			&nbsp;&nbsp;&nbsp;
			<input type="text" name="MEMBER_ZIPCODE1" size="6" onkeypress="gNumCheck()" 
				maxlength="3" value="<%=zipcodes[0].trim() %>" /> - 
			<input type="text" name="MEMBER_ZIPCODE2" size="6" onkeypress="gNumCheck()" 
